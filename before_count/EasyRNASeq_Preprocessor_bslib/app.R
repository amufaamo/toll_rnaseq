...
ui <- page_navbar(
    title = "EasyRNA-Seq Preprocessor",
    theme = bs_theme(
        bootswatch = "flatly",
        version    = 5
    ),
    ...
    # Docker status in navbar (right side)
    nav_spacer(),
    nav_item(
        tags$span(
            class = "navbar-text",
    ...
    nav_panel(
        title = tagList(icon("database"), " Reference Prep"),
        layout_sidebar(
            sidebar = sidebar(
                width = 340,
                open  = TRUE,
                ...
                card(
                    ...
                    conditionalPanel(
                        ...
                        shinyDirButton("download_dest_dir", "Download Destination", "Select folder to save downloaded files"),
    ...
    nav_panel(
        title = tagList(icon("chart-bar"), " QC & Quant"),
        layout_sidebar(
            sidebar = sidebar(
                width = 340,
                open  = TRUE,
                ...
                card(
                    ...
                    checkboxInput("t2_run_falco",  "FastQC (Falco) Pre/Post Trim", value = TRUE),
    ...
    nav_panel(
        title = tagList(icon("dna"), " De novo Assembly"),
        layout_sidebar(
            sidebar = sidebar(
                width = 340,
                open  = TRUE,
